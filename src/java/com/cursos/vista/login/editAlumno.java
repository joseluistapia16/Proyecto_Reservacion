...
public class editAlumno extends GenericForwardComposer {
// @Inject
...
public void onCreate$venprofesor(){
    ...
    public void init() {
       ...
       id_alumno = clav;
        lista= consu.ConsultaEstudiante("cursos","select * from alumnos where id_alumno='"+clav+"'");
    ...
    public void record(String cadena) {
        ...
        try {
            String camp = "nombre,apellido,telefono,direccion,correo";
            ...
            Logger.getLogger(editAlumno.class.getName()).log(Level.SEVERE, null, ex);
        }
