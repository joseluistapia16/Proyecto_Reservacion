...
public class Consulta_Estudiantes extends javax.swing.JDialog {
    ...
    public Consulta_Estudiantes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton5.setBounds(570, 40, 90, 40);
        ...
        jLabel2.setBounds(140, 40, 60, 40);
        ...
        Cedula.setBounds(200, 40, 230, 40);
        ...
        jButton1.setBounds(440, 40, 120, 40);
...
private void TablaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TablaFocusGained
    ...
    private void llenaTabla() {
        ...
        lista = Archivo.LeerEstudiantes("Estudiantes.obj");
        String[] Co = {"Cedula ", "Nombres y Apellidos"};
        model = new DefaultTableModel(null, Co);
        Tabla.setShowGrid(true);
        for (int i = 0; i < lista.size(); i++) {
            Filas[0] = lista.get(i).getCedula();
            Filas[1] = lista.get(i).getNombre() + " " + lista.get(i).getApellido();
            model.addRow(Filas);
    ...
    public Estudiante devuelveObjeto(String cedula, ArrayList<Estudiante> listaobj) {
...
// TODO add your handling code here:
    if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
        ...
        Estudiante obj = devuelveObjeto(Tabla.getValueAt(i, 0).toString(), lista);
        if (obj != null) {
            estudianteEditor gh = new estudianteEditor(new javax.swing.JFrame(), true, obj, Integer.parseInt(obj.getId_estudiante().toString()));
            gh.setVisible(true);
            lista.clear();
            llenaTabla();
        }
...
// TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // TODO add your handling code here:
        nuevoEstudiante in = new nuevoEstudiante(new javax.swing.JFrame(), true);
        in.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consulta_Estudiantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                Consulta_Estudiantes dialog = new Consulta_Estudiantes(new javax.swing.JFrame(), true);
